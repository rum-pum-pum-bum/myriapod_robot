...
#Notes
    #left side segment 2 has more resistance
    #'left' motors have to be backward
    #carpeted surface achieves best results
    #0.25 speed is too slow to move on carpeted surface
    #0.5 speed can run on carpet
